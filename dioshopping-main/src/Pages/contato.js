    ...
    return(
        <Container>
            <Grid container direction="row" xs={12}>
                ...
                <TextField id="message" label="Menssagem" value={content} onChange={(event)=>{setContent(event.target.value)}} fullWidth/>
            </Grid>
                ...
                return(
                    <div className="card mt-2" key={content.id}>
                        <div className="card-body">
                            ...
                            <p className="card-text"><small className="text-muted"><Moment locale="pt-BR" formt=" DD MMM YYYY">{content.created_at}</Moment></small></p>
                        </div>
                    </div>
                )
            } )}
